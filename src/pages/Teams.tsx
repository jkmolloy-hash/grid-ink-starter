...
export default function Teams() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-5 py-14">
      ...
      <div className="mt-8 bg-[#17191c] p-[10px] rounded shadow-sheet">
        <div className="bg-white p-4">
          <img src="/gallery/team-example.jpg"
               alt="Hand-plotted team poster: two linemen in blue ink with the full roster lettered in gold"
      ...
      <div className="mt-12 grid gap-8 sm:grid-cols-3">
        {[
          ...
          <div key={h}>
            ...
            <p className="caption mt-2">{p}</p>
          </div>
        ))}
      </div>

      <div className="mt-12 p-6 rounded border border-ink/15 bg-paper">
        <div className="font-semibold">What families get</div>
        <p className="caption mt-2">
          A hand-plotted piece at $98, framed, US shipping included
          &mdash; in portrait or landscape. Every name on the roster is
