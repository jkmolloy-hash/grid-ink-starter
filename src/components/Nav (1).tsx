      ...
      <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-4 sm:gap-5">
          <Link to="/create?product=sports"
            ...
            <span className="hidden sm:inline">Sports Line Art</span>
          </Link>
          <Link to="/create?product=city"
                className="font-semibold hover:underline underline-offset-4">
            City Maps
          </Link>
          <Link to="/create?product=custom"
                className="hidden sm:inline font-semibold hover:underline underline-offset-4">
            Custom
          </Link>
          <Link to="/contact"
                className="hidden md:inline font-semibold hover:underline underline-offset-4">
            Contact
          </Link>
          {studio && (
            <Link to="/studio"
